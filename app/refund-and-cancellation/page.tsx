    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold text-center text-black mb-6">Refund & Cancellation Policy</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="prose prose-lg max-w-none">
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Subscription Purchases</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Free Plan</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Refund Request Process</h2>
              <p className="text-gray-700 mb-6">
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Subscription Cancellations</h2>
              <p className="text-gray-700 mb-6">For users with recurring subscription plans:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">How to Cancel Your Subscription</h2>
              <p className="text-gray-700 mb-6">To cancel your subscription:</p>
              <ol className="list-decimal list-inside space-y-2 text-gray-700 ml-4">
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Special Considerations</h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-black mb-3">Trading Results</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black mb-3">Promotional Credits</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black mb-3">Account Violations</h3>
                  <p className="text-gray-700">
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Billing Disputes</h2>
              <p className="text-gray-700 mb-6">
            ...
            <section>
              <h2 className="text-3xl font-bold text-black mb-6">Currency and Processing</h2>
              <p className="text-gray-700 mb-6">
            ...
            <section>
              ...
              <p className="text-gray-700 mb-6">If you have any questions about our Refund & Cancellation Policy, please contact us:</p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                <li><strong className="text-black">Email:</strong> support@viewmarket.in</li>
                <li><strong className="text-black">Billing Issues:</strong> support@viewmarket.in</li>
                <li><strong className="text-black">Phone:</strong> 9241740350</li>
                <li><strong className="text-black">Business Hours:</strong> Monday to Friday, 9:00 AM to 6:00 PM IST</li>
              </ul>
            </section>
          </div>
        </div>
